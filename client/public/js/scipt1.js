const images = [
  ...
  // content setup
  const texts = [
    ["Register Page", "Don't be the broken one"],
    ["Login Page", "Don't be the broken one"],
  ];
  ...
  rgbKineticSlider = new rgbKineticSlider({
    ...
    transitionScaleAmplitude: 340, // scale amplitude during transition
